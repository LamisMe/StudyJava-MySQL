        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="/bai-hoc?action=them" method="post" name="form-2" id="form-2"
                            ...
                            <div class="col-12 col-md-9">
                                <div class="form-check-inline form-check " >
                                    ...
                                    <label for="inline-radio1" class="form-check-label">
                                        <input type="radio" id="inline-radio1" value="1" name="doKho" style="margin-left: 10px"
                                               class="form-check-input" <c:if test="${luachon eq 1}">checked</c:if>>Trung Binh
                                    </label>
                                    <label for="inline-radio2" class="form-check-label ">
                                        <input type="radio" id="inline-radio2" value="2" name="doKho" style="margin-left: 10px"
                                               class="form-check-input" <c:if test="${luachon eq 2}">checked</c:if>>Kho
                                    </label> <label for="inline-radio3" class="form-check-label ">
                                        <input type="radio" id="inline-radio3" value="3" name="doKho" style="margin-left: 10px"
